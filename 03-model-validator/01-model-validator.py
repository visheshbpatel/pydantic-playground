...
class Patient(BaseModel):
    ...
    def validate_emergency_contact(self):
        if self.age > 60 and 'emergency' not in self.contact_details:
            raise ValueError("Patients older than 60 must have an emergency contanct")
        return self
...
patient1_info = {"name":"vbp", "email":"vbp@hdfc.com", "hospital_url": "https://www.apollohospitals.com", "age":"65", "weight":65,  'contact_details':{'phone':789789, 'emergency':898989}}
